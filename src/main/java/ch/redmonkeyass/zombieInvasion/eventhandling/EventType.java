...
public enum EventType {
  ...
  // PRESSED
  W_RELEASED, A_RELEASED, S_RELEASED, D_RELEASED, G_RELEASED, K_RELEASED, DEBUG_CONSOLE_KEY_F1_RELEASED, RIGHT_ARROW_RELEASED, LEFT_ARROW_RELEASED, UP_ARROW_RELEASED, DOWN_ARROW_RELEASED,
